...
enum MotorRoutine{
    CLAW_DOWN,CLAW_DOWN_EDGE,CLAMP,RELEASE,
    CLAW_UP,CLAW_UP_EDGE,CLAW_HALF_WAY_UP,
    CLAW_RIGHT_WAY_UP,CLAW_UPSIDE_DOWN,STOP_ALL
};
...
public:
    ...
    friend std::ostream& operator<<(std::ostream& s,const Mechanisms& m);
};
